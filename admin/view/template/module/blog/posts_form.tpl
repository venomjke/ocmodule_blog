      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab_general">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $this->language->get('entry_post_anons'); ?></td>
              <td><textarea name="anons" id="anons"><?php echo $anons;  ?></textarea>
                <?php if ($error_anons) { ?>
                <span class="error"><?php echo $error_anons; ?></span>
                <?php } ?></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $this->language->get('entry_post_description'); ?></td>
        ...
        <div id="tab_data">
          <table class="form">
            ...
            <tr>
            	<td> <?php echo $this->language->get('entry_post_cats'); ?> </td>
            	<td> 
            				<select name="post_cats[]" multiple style="width:200px;">
	            			<?php foreach($cats as $cat): ?>
            					<option value="<?php echo $cat['id']?>" <?php echo in_array($cat['id'],$post_cats)?'selected="selected"':'';?>> <?php echo $cat['title']; ?></option>
		            		<?php endforeach;?>
            				</select>
            	</td>
            </tr>
